...
<div class="wrap">
    ...
    <h2><?php esc_html_e('Location', 'wp-dealer-map')?>
        <a class="add-new-h2"
            href="<?php echo esc_url(get_admin_url(get_current_blog_id(), 'admin.php?page=dealer_map/dealer_map_locations')); ?>">
        ...
        <div class="metabox-holder" id="poststuff">
            <div id="post-body">
                <div id="post-body-content">
                    <input type="submit" value="<?php esc_attr_e('Save Location', 'wp-dealer-map')?>"
                        style="margin-bottom: 20px;" class="button-primary" name="submit">
                    <?php do_meta_boxes('location', 'normal', $item);?>
                    <input type="submit" value="<?php esc_attr_e('Save Location', 'wp-dealer-map')?>" id="submit"
